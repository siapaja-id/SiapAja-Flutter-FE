...
final List<Author> mockAuthors = [
  const Author(name: 'Alice Smith', handle: 'alicesmith', avatar: 'https://picsum.photos/seed/alice/100/100', verified: false, isOnline: true),
  const Author(name: 'Bob Jones', handle: 'bobjones', avatar: 'https://picsum.photos/seed/bob/100/100', verified: true, isOnline: true),
  const Author(name: 'Charlie Day', handle: 'charlie_day', avatar: 'https://picsum.photos/seed/charlie/100/100', verified: false, isOnline: false),
  const Author(name: 'Diana Prince', handle: 'diana', avatar: 'https://picsum.photos/seed/diana/100/100', verified: true, isOnline: true),
  const Author(name: 'Evan Wright', handle: 'evanw', avatar: 'https://picsum.photos/seed/evan/100/100', verified: false, isOnline: false),
];
...
final List<FeedItem> sampleData = [
  ...
  SocialPostData(
    ...
    replyAvatars: [mockAuthors[0].avatar, mockAuthors[1].avatar, mockAuthors[3].avatar],
  ),
  SocialPostData(
    id: 'social-8',
    author: mockAuthors[1],
